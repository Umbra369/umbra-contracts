...
/// acceptance (a real `execute` with a valid sig) is asserted in UmbraRouterV3Fee.t.sol.
contract UmbraRouterV3ConfigTest is Test {
    UmbraRouterV3 r;
    ...
    function setUp() public {
        ...
        r = new UmbraRouterV3(W, P2, empty, empty, empty);
    }
    ...
    function test_setFeeConfig_owner_only_and_validated() public {
        ...
        vm.expectRevert(UmbraRouterV3.NotOwner.selector);
        r.setFeeConfig(5000, 25, address(0x5169));

        // enabled (feeBps != 0) but no signer -> BadFeeConfig
        vm.expectRevert(UmbraRouterV3.BadFeeConfig.selector);
    ...
    function test_two_step_fee_recipient() public {
        ...
        vm.expectRevert(UmbraRouterV3.NotPendingFeeRecipient.selector);
        r.acceptFeeRecipient();
